...
Кастомні домени `cym.ee` та `www.cym.ee` налаштовані у дашборді Cloudflare
(Workers & Pages → `cym-ee` → Domains) і деплоєм не змінюються. Там само на рівні
зони увімкнено `Always Use HTTPS` і встановлено мінімальну версію TLS 1.2.

## Ліцензія

Вихідний код поширюється за ліцензією [MIT](LICENSE).

Copyright © 2026 Osmyka OÜ — розробник і власник майнових прав на код.

Ліцензія MIT поширюється **виключно на програмний код**. Вона не надає прав на:

- текстові матеріали, фотографії та інші матеріали сайту, що належать
  Спілці української молоді в Естонії;
- назву, логотип, емблему та інші засоби індивідуалізації СУМ;
- назву та торговельні позначення Osmyka OÜ.

Тобто код можна вільно використовувати, змінювати та застосовувати у власних
проєктах за умови збереження тексту ліцензії й повідомлення про авторське
право. Використання матеріалів і символіки організації потребує окремого
